...
<div class="master-slider ms-skin-default" id="masterslider">
  ...
  <img src="js/masterslider/blank.gif" data-src="http://placehold.it/1920x650" alt=""/>
    ...
    <h3 class="ms-layer text76"
          ...
          data-duration="1230"
          data-effect="left(250)"> Digital</h3>

    <h3 class="ms-layer text77"
          style="left: 200px;top: 260px;"
          data-type="text"
          data-delay="1000"
          data-ease="easeOutExpo"
          data-duration="1230"
          data-effect="right(250)"> Agency</h3>
  ...
  <div class="ms-slide slide-2" data-delay="9">
    ...
    <h3 class="ms-layer text59"
          ...
          data-ease="easeOutExpo"
          data-duration="1230"
          data-effect="scale(1.5,1.6)"> Many More Features </h3>

    <h3 class="ms-layer text3"
          style="left: 230px; top: 330px;"
          data-type="text"
          data-effect="top(45)"
          data-duration="2000"
          data-delay="2500"
  ...
  <div class="ms-slide" data-delay="10">
    ...
    <img src="../masterslider/style/blank.gif" data-src="http://placehold.it/1920x650" alt="lorem ipsum dolor sit">
    ...
    <h3 class="ms-layer text80"
          ...
          data-ease="easeOutExpo"
          data-duration="1230"
          data-effect="right(250)"> Backgrounds</h3>

    <h3 class="ms-layer small-line"
          style="left: 720px; top: 330px;"
          data-type="text"
          data-delay="1500"
          data-ease="easeOutExpo"
          data-duration="1230"
  ...
  <img src="js/masterslider/blank.gif" data-src="http://placehold.it/1920x650" alt=""/>
    ...
    <h3 class="ms-layer text82"
          ...
          data-ease="easeOutExpo"
          data-duration="1230"
          data-effect="left(250)"> Modern & </h3>
    ...
    <h3 class="ms-layer text83"
          ...
          data-ease="easeOutExpo"
          data-duration="1230"
          data-effect="right(250)"> Creative</h3>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h6 class="nopadding lspace-1">Who We Are</h6>
        <h1 class="paddtop1 dosis font-weight-5 lspace-sm">About <span class="text-orange-2">Us</span></h1>
        <div class="title-line-4 align-center"></div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-6 col-sm-12 col-xs-12 bmargin animate-in" data-anim-type="fade-in-right" data-anim-delay="100">
        <div class="col-md-6 col-sm-6 col-xs-12 nopadding">
          <div class="feature-box-101 bmargin">
            <div class="circle">
              <h4 class="title text-white">Our History</h4>
            </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 padding-left-4">
          ...
          <br/>
          <a href="#" class="read-more orange-2"> <i class="fa fa-long-arrow-right"></i> Read more</a> </div>
      </div>
      <!--end item-->

      <div class="col-md-6 col-sm-12 col-xs-12 bmargin animate-in" data-anim-type="fade-in-left" data-anim-delay="200">
        <div class="col-md-6 col-sm-6 col-xs-12 nopadding">
          <div class="feature-box-101 bmargin">
            <div class="circle">
              <h4 class="title text-white">Our Passion</h4>
            </div>
            <div class="img"><img src="http://placehold.it/200x200" alt=""/></div>
          </div>
        </div>
      ...
      <div class="col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-2 text-inner clearfix align-left">
        <div class="text-box white padding-7">
          <div class="col-xs-12 text-left">
            ...
            <h1 class="paddtop1 dosis font-weight-5 lspace-sm">Awesome Featur<span class="text-orange-2">es</span></h1>
            <div class="title-line-4"></div>
          </div>
          <div class="clearfix"></div>
          <ul class="iconlist orange">
            <li><i class="fa fa-check"></i> Sed massa tellus aliquam rhoncus venenatis quis enim Sed massa tellus aliquam. </li>
            <li><i class="fa fa-check"></i> Development dolor sit amet consectetur adipiscing elit Phasellus hendrerit condimentum dapibus. </li>
            <li><i class="fa fa-check"></i> Etiam dictum Nunc enim Sed massa tellus aliquam rhoncus venenatis</li>
            <li><i class="fa fa-check"></i> Magna eget scelerisque metus dictum Nunc enim Sed massa massa in neque sit consectetur </li>
            <li><i class="fa fa-check"></i> Vitae hendrerit condimentum dapibus ac nulla dictum Nunc enim Sed massa. </li>
            <li><i class="fa fa-check"></i> Magna, eget scelerisque metus massa in neque dapibus </li>
          </ul>
          <br/>
          <br/>
          <a href="#" class="btn btn-orange-2 dark btn-xround">Read more</a> </div>
      </div>
    </div>
  </div>
</section>
...
<h1 class="font-weight-6 less-mar1 nopadding">Creative <span class="text-orange-2">Hasta</span></h1>
<h5>Multi purpose Responsive Template</h5>
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo.</p>
<br/>
...
<div class="clearfix"></div>
<br/><br/>
<a class="btn btn-orange-2 dark btn-xround" href="#">View Projects <i class="fa fa-angle-right"></i></a>
...
<section class="sec-padd-default-page">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h6 class="nopadding lspace-1">Who We Are</h6>
        <h1 class="paddtop1 dosis font-weight-5 lspace-sm">Meet Our Te<span class="text-orange-2">am</span></h1>
        <div class="title-line-4 align-center"></div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-4 col-sm-6">
        <div class="team-holder15 two bmargin">
          <div class="team-member"><img src="http://placehold.it/500x450" alt="" class="img-responsive"/></div>
          <div class="info-box text-center">
            <h5 class="uppercase less-mar2">John William</h5>
            <span class="text-orange-2">Founder and CEO</span> <br/>
            <br/>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo et Praesent Lorem ipsum dolor sit amet</p>
          </div>
        </div>
      </div>
      <!--end item-->
      ...
      <div class="col-md-4 col-sm-6">
        <div class="team-holder15 two bmargin">
          ...
          <div class="info-box text-center">
            ...
            <span class="text-orange-2">Creative Designer</span> <br/>
            <br/>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo et Praesent Lorem ipsum dolor sit amet</p>
          </div>
        </div>
      ...
      <div class="col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-4 text-inner clearfix align-left">
        <div class="text-box white padding-7">
          <div class="col-xs-12 text-left">
            ...
            <h1 class="paddtop1 dosis font-weight-5 lspace-sm">Our Servic<span class="text-orange-2">es</span></h1>
            <div class="title-line-4"></div>
          </div>
          <div class="clearfix"></div>
          <div class="col-md-4">
...
<section class="sec-padd-default-page">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h6 class="nopadding lspace-1">What We Do</h6>
        <h1 class="paddtop1 dosis font-weight-5 lspace-sm">Our Wor<span class="text-orange-2">ks</span></h1>
        <div class="title-line-4 align-center"></div>
      </div>
      <div class="clearfix"></div>
      <div class="demo-full-width">
        <div id="grid-container" class="cbp">
          <div class="cbp-item identity logos"> <a href="http://placehold.it/800x800" class="cbp-caption cbp-lightbox" data-title="Suspendisse Imperdiet<br>by Codelayers">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x800" alt=""> </div>
          ...
          <div class="cbp-item web-design"> <a href="http://placehold.it/800x800" class="cbp-caption cbp-lightbox" data-title="Magna Tempus Urna<br>by Codelayers">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x800" alt=""> </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignLeft">
                <div class="cbp-l-caption-body">
          ...
          <div class="cbp-item motion identity"> <a href="http://placehold.it/800x800" class="cbp-caption cbp-lightbox" data-title="World Clock Widget<br>by Codelayers">
            <div class="cbp-caption-defaultWrap"> <img src="http://placehold.it/800x800" alt=""> </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignLeft">
                <div class="cbp-l-caption-body">
...
<section class="sec-padding section-orange-2">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h1 class="dosis text-white lspace-sm">Newsletter</h1>
        <p class="sub-title text-white">Lorem ipsum dolor sit amet consectetuer adipiscing elit Suspendisse et.</p>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-12">
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        ...
        <h1 class="paddtop1 dosis font-weight-5 lspace-sm">Our Work Proce<span class="text-orange-2">ss</span></h1>
        <div class="title-line-4 align-center"></div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-3 col-sm-6 col-xs-12 text-center animate-in" data-anim-type="fade-in-right" data-anim-delay="100">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 text-center animate-in" data-anim-type="fade-in-right" data-anim-delay="200">
        <div class="feature-box-102 bmargin">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 text-center animate-in" data-anim-type="fade-in-right" data-anim-delay="300">
        <div class="feature-box-102 bmargin">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 text-center animate-in" data-anim-type="fade-in-right" data-anim-delay="400">
        <div class="feature-box-102 bmargin">
...
<section>
  ...
  <div class="divider-line solid light opacity-5"></div>
    <div class="row sec-padd-default-page">
      <div class="col-xs-12 text-center">
        <h6 class="nopadding lspace-1">Latest News</h6>
        <h1 class="paddtop1 dosis font-weight-5 lspace-sm">From the Bl<span class="text-orange-2">og</span></h1>
        <div class="title-line-4 align-center"></div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="blog-holder-13 bmargin">
          <div class="image-holder">
            ...
            <div class="post-date-box"> 15 <span>August, 2015</span> <span class="icon"><i class="fa fa-picture-o"></i></span> </div>
          ...
          <div class="blog-post-info"> <span><i class="fa fa-user"></i> By Benjamin</span> <span><i class="fa fa-comments-o"></i> 15 Comments</span> <span><i class="fa fa-folder-open"></i> category / Business</span> </div>
          <br/>
          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est. Lorem ipsum dolor sit amet .</p>
        </div>
      </div>
      <!--end item-->
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="blog-holder-13 bmargin">
          <div class="image-holder">
            <div class="shapes"></div>
            <div class="post-date-box"> 25 <span>July, 2015</span> <span class="icon"><i class="fa fa-film"></i></span> </div>
            <img src="http://placehold.it/1000x700" alt="" class="img-responsive"/> </div>
          <div class="clearfix"></div>
          <br/>
          <br/>
    ...
    <div class="container sec-tpadding-3 sec-bpadding-3">
      <div class="row">
        <div class="col-md-8 col-centered">
          ...
          <br/>
          <br/>
          <a class="btn btn-orange-2 btn-xround" href="#">Read more</a></div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec-padd-default-page">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 text-center">
        <h6 class="nopadding lspace-1">Package Details</h6>
    ...
    <div class="row no-gutter">
      <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="pricetable-holder7">
          ...
          <br/>
          <br/>
          <a class="btn btn-orange-2 dark btn-xround" href="#">Order Now !</a> </div>
      </div>
      <!--end item-->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="pricetable-holder7 active bmargin">
          ...
          <br/>
          <br/>
          <a class="btn btn-white btn-xround" href="#">Order Now !</a> </div>
      </div>
      <!--end item-->
  ...
  <div class="section-overlay bg-opacity-7">
    <div class="container sec-tpadding-3 sec-bpadding-3">
      <div class="row slide-controls-color-13">
        <div class="col-md-8 col-centered">
          <div class="col-xs-12 text-center">
            <h6 class="nopadding lspace-1 text-white">Our Clients</h6>
            <h1 class="paddtop1 dosis font-weight-5 text-white lspace-sm">People Sa<span class="text-orange-2">ys</span></h1>
            <div class="title-line-4 white align-center"></div>
          </div>
          <div class="clearfix"></div>
          <div id="owl-demo3" class="owl-carousel">
            <div class="item">
              <blockquote class="style1"><span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit augue. Cras tellus. In pulvinar lectus a est.</span> </blockquote>
              <br/>
              <h5 class="text-white less-mar1">Emily</h5>
              <span class="text-orange-2">Nullam turpis</span> </div>
            <!--end slide item-->
