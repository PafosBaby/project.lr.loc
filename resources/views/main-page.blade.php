...
@section('content')
    ...
    <div class="master-slider ms-skin-default" id="masterslider">
        ...
        <div class="ms-slide slide-2" data-delay="9">
            ...
            <h3 class="ms-layer text58" style="left: 230px;top: 200px;" data-type="text" data-delay="1500"
                data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> {{__("One Page Layouts")}} & </h3>

            <h3 class="ms-layer text59" style="left: 230px;top: 245px;" data-type="text" data-delay="2000"
                data-ease="easeOutExpo" data-duration="1230" data-effect="scale(1.5,1.6)"> {{__("Many More Features")}} </h3>
            ...
            <a class="ms-layer sbut2" style="left: 390px; top: 420px;" data-type="text" data-delay="3000"
                data-ease="easeOutExpo" data-duration="1200" data-effect="scale(1.5,1.6)"> {{__("Purchase now")}} ! </a>
        ...
        <div class="ms-slide slide-3" data-delay="9">
            ...
            <h3 class="ms-layer text82" style="left: 430px;top: 180px;" data-type="text" data-delay="1500"
                data-ease="easeOutExpo" data-duration="1230" data-effect="left(250)"> {{__("Modern")}} & </h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <h1 class="paddtop1 dosis font-weight-5 lspace-sm">{{__("About")}} <span class="text-orange-2">{{__("Us")}}</span></h1>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 bmargin animate-in" data-anim-type="fade-in-right"
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 padding-left-4">
                        ...
                        <br />
                        <a href="#" class="read-more orange-2"> <i class="fa fa-long-arrow-right"></i> {{__("Read more")}}</a>
                    </div>
                </div>
                <!--end item-->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 screens-top-padding bmargin">
                    <h1 class="font-weight-6 less-mar1 nopadding">{{__("Creative")}} <span class="text-orange-2">Hasta</span></h1>
                    ...
                    <div class="clearfix"></div>
                    <br /><br />
                    <a class="btn btn-orange-2 dark btn-xround" href="#">{{__("View Projects")}}<i class="fa fa-angle-right"></i></a>
    ...
    <section>
        <div class="videobgholder">
                        ...
                        <div class="video-overlay bg-opacity-5">
                            <div class="container video-toppadd video-bopadd">
                                <div class="col-md-8 col-centered text-center">
                                    <h2 class="text-white section-title ubuntu less-mar2 uppercase">{{__("Add Your Own")}}</h2>
                                    <h2 class="text-white section-title ubuntu uppercase">{{_("Youtube Video Backgrounds")}}</h2>
            ...
            <a id="video" class="player" data-property="{videoURL:'CWqndeS1Iu0',containment:'#customElement', showControls:false, autoPlay:true, loop:true, vol:50, mute:true, startAt:90,  stopAt:109, opacity:1, addRaster:true, quality:'hd720', optimizeDisplay:true}">{{__("My video")}}</a>
        </div>
    </section>
    <!--end section-->
    <div class="clearfix"></div>
    ...
    <section class="sec-padd-default-page">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h6 class="nopadding lspace-1">{{__("Who We Are")}}</h6>
                    <h1 class="paddtop1 dosis font-weight-5 lspace-sm">{{__("Meet Our Te")}}<span class="text-orange-2">{{__("am")}}</span>
                    </h1>
                    <div class="title-line-4 align-center"></div>
                </div>
                <div class="clearfix"></div>
    ...
    <section class="sec-padd-default-page">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h6 class="nopadding lspace-1 ">{{__("What We Do")}}</h6>
                    <h1 class="paddtop1 dosis font-weight-5 lspace-sm">{{__("Our")}} Wor<span class="text-orange-2">ks</span></h1>
                    <div class="title-line-4 align-center"></div>
                </div>
                <div class="clearfix"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <h1 class="paddtop1 dosis font-weight-5 lspace-sm">{{_("Our Work")}} Proce<span class="text-orange-2">ss</span>
                    </h1>
                    <div class="title-line-4 align-center"></div>
                </div>
                <div class="clearfix"></div>
